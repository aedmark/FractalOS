window.PaintUI = class PaintUI {
    ...
    _buildAndShow(initialState) {
        ...
        if (isWindowed) {
            this.elements.container = Utils.createElement('div', { id: 'fractalos-paint-app-container', className: 'paint-windowed-container', style: 'width: 100%; height: 100%; display: flex; flex-direction: column;' });
            ...
            const appWindow = UIComponents.createAppWindow('FractalOS Paint', this.managerCallbacks.onExitRequest);
            ...
            this.elements.container.id = 'fractalos-paint-app-container';
        }
