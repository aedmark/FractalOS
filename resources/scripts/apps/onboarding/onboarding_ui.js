...
window.OnboardingUI = class OnboardingUI {
    ...
    _renderStep1(state) {
        ...
        form.append(
            Utils.createElement('h1', { textContent: 'Welcome to FractalOS' }),
    ...
    _renderStep3(state) {
        ...
        const summary = Utils.createElement('div', { className: 'onboarding-summary' }, [
            ...
            Utils.createElement('p', { textContent: 'Review your setup details below. Click "Finish & Reboot" to start your FractalOS session.' }),
    ...
    _renderComplete(state) {
        ...
        const completeMessage = Utils.createElement('div', {}, [
            ...
            Utils.createElement('p', { textContent: 'Your system is being configured. FractalOS will reboot shortly.' })
        ]);
